    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.professionalvalidation')),
            ],
        ),
        migrations.CreateModel(
            name='Client',
            fields=[
                ...
                ('service', models.CharField(max_length=255, null=True)),
                ('validation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.clientvalidation')),
            ],
        ),
    ]
